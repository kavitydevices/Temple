...
import static com.apps.jaywalker.kaveri_b.AppConstants.REDIRECT_URL;
...
/*    private String getApplicationName(Context context, String data, int flag) {
    ...
    private void createOrder() {
        ...
        int orderAmount = getIntent().getIntExtra(AppConstants.EXTRAS_ORDER_AMOUNT,1);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            if (response.has("PaymentProcessUrl")) {
                                ...
                                PreferenceUtils.saveOrderId(response.getString("OrderKeyId"),getApplicationContext());
                                value=response.getString("UpiLink");
                                Log.d(TAG, "upilink  " + value);

                                if(value!=null){
                                    startActivity(new Intent(PaymentActivity.this, qrcodeGenerator.class));
                                }
    ...
    private void processForPayment(String url) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                Logger.logDebug(TAG, "Payg page started getting trouble: " + url);
                progressBar.setVisibility(View.VISIBLE);
