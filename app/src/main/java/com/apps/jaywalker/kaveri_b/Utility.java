...
//    / <MerchantAuthenticationKey>:<MerchantAuthenticationToken>:M:<MerchantKeyId>
     ...
     * @return
     */
    public static JSONObject generateJsonRequest(String merchantId, int uniqueRequestId, int orderAmount, String customerMobileNo, String redirectURL, String walletType) {
        ...
        try {
            ...
            productdata.put("Payment Reason", "Subscription");



            String productda= String.valueOf(productdata);
            jsonObject.put("ProductData", productda);
...
//            jsonObject.put("TransactionData", null); // old one
            ...
            /*"AcceptedPaymentTypes":null,"SurchargeType":null,"SurchargeValue":0.0,"Card":null,"Ach":null,"Wallet":null,"Upi":null,
                    "NetBanking":null,"Card3DSecure":null,"RefTransactionId":null,
                    "IndustrySpecicationCode":null,"PartialPaymentOption":nul
            */

            JSONObject jsonObjTransactionData = new JSONObject();
            jsonObjTransactionData.put("AcceptedPaymentTypes", null);
            jsonObjTransactionData.put("SurchargeType", null);
            jsonObjTransactionData.put("SurchargeValue", 0.0);
            jsonObjTransactionData.put("Card", null);
            jsonObjTransactionData.put("Ach", null);
            jsonObjTransactionData.put("Wallet", null);
            jsonObjTransactionData.put("Upi", null);
            jsonObjTransactionData.put("NetBanking", null);
            jsonObjTransactionData.put("Card3DSecure", null);

            jsonObjTransactionData.put("RefTransactionId", null);
            jsonObjTransactionData.put("IndustrySpecicationCode", null);
            jsonObjTransactionData.put("PartialPaymentOption", null);



            // Wallet/UPI/CreditCard/DebitCard (This is seamless integration it will navigate to payment option directly without going to payment gateway page)
...
//            },
            ...
            jsonObject.put("SplitPaymentData", null);
